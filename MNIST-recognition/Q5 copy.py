...
# parameters
batch_size_train=64 # change the batchsize when testing the parameters
batch_size_test=64
...
def train():
    ...
    weight_decay=0.01 #change when testing the parameters
    training_epochs=5
    n_classes=10
    ...
    for learning_rate in learning_rate_list:
        ...
        writer.add_scalar('Learning_rate/test', learning_rate)
        writer.add_scalar('Batchsize/train', batch_size_train)
        print("batch_size={},learning_rate={}, accuracy={}".format(batch_size_train, learning_rate,accuracy))
