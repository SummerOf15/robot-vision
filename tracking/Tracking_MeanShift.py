...
# mask = cv2.inRange(hsv_roi, np.array((0.,30.,30.)), np.array((180.,200.,230.)))
mask = cv2.inRange(hsv_roi, np.array((0.,20.,20.)), np.array((180.,255.,235.)))
...
while(1):
    ...
    # current image hsv, i.e. dst(x,y) = roi_hist(hsv(0,x,y))
        ...
        if k == 27:
            ...
            cv2.imwrite('Dst_%04d.png'%cpt,dst)
        cpt += 1
    else:
        break
